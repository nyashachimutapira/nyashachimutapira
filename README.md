...
- Tools & DevOps: Git, GitHub, Docker, Linux, basic CI/CD
- Cloud: AWS fundamentals (EC2, S3)
- Concepts: Data Structures & Algorithms, OOP, RESTful APIs, TDD
...
- Repo: [View on GitHub](https://github.com/nyashachimutapira/campusconnect.git)
...
- Repo: [View on GitHub](https://github.com/nyashachimutapira/AlgoPractice.git)
...
## 🤝 Collaboration
I welcome issues, feedback, and contributions. If you would like to collaborate, please open an issue or send me a message on LinkedIn or by email.
